...
{
    public partial class FormAGV_COM2 : UIForm
    {
        ...
        byte[] SendHandShakeUnload55 = { 0xB5, 0xFF, 0xFF, 0x03, 0x01, 0x10, 0xAF, 0xE3, 0xE8, 0x5B };
        ...
        private void FormAGV_COM_Load(object sender, EventArgs e)
        {
            ...
            AddListMsg("AGV窗口初始化，启用COM22串口接收数据");
            AddListMsg("界面显示！");
            ...
            Task.Run(() =>
               {
                   try
                   {
                       ...
                       //   ComPortAGV.PortName = "COM20";
                       ComPortAGV.PortName = "COM22";
                ...
                try
                {
                    ...
                    if (read_data[0] == 0xB5)
                    {
                        if ((read_data[4] == 0x01) && ((agvWorkFlagIn == false)) && (agvWorkFlagOut == false) && (m_ucLoadAGVStep == 20))
                        {
                            ...
                            if ((read_data[2] == 0x0A) && ((read_data[6] == 0x5A) || (read_data[6] == 0xAA)))
                            {
                                AddListMsg("轨道任务A0,只接收无传送");
                                m_ucLoadAGVStep = 0;
                                m_AGVHandShakeState = 1;
                            }
                            else if ((read_data[2] == 0xF0))
                            {
                        ...
                        else if ((read_data[4] == 0x01) && ((agvWorkFlagIn == true) || (agvWorkFlagOut == true)) && ((m_ucLoadAGVStep == 20) || (m_ucLoadAGVStep == 0) || (m_ucLoadAGVStep == 2)))
                        {
                            AddListMsg("AGV机器人请求握手,AGV模式已启动");

                            if (((read_data[2] == 0xA0) && ((read_data[6] == 0xA5) || (read_data[6] == 0xAA))) && (agvWorkFlagIn == true))
                            {
                                AddListMsg("#轨道任务A0,只接收无传送");
                                m_ucLoadAGVStep = 1;
                                m_AGVHandShakeState = 1;
                            }
                            else if (((read_data[2] == 0x0F)) && (agvWorkFlagOut == true))
                            {
                                AddListMsg("#轨道任务0F,只传送无接收");
                                m_ucLoadAGVStep = 1;
                                m_AGVHandShakeState = 2;
                        ...
                        else if (read_data[4] == 0xEE)
                        {
                            ...
                            {
                                //axActUtlType1.SetDevice2("M1218", 0); //缩回
                                //axActUtlType1.SetDevice2("M1219", 0);
                                //Thread.Sleep(10);

                                axActUtlType1.SetDevice2("M100", 0);
                                axActUtlType1.SetDevice2("M150", 0);
                                axActUtlType1.SetDevice2("M950", 0);
                                axActUtlType1.SetDevice2("M1000", 0);

                                axActUtlType1.SetDevice2("M1755", 0);
                                axActUtlType1.SetDevice2("M1757", 0);
                        ...
                        else if (read_data[4] == 0xAA)
                        {
                            ...
                            {                                                                          //AGV停止   关夹紧气缸  皮带停止转动
                                ...
                                AddListMsg("收到AGV异常停止指令0xAA,设备已经完成了对接，不再响应AGV的报警,开始自动化运行。");
                            }
        ...
        *********************************************************************************************************/
            ...
            try
            {
                ...
                if (LogQueue.Count > 0)
                {
                    if (LogBox.IsHandleCreated)
                    {
                        ...
                        m_Log.Write("右侧进:" + FormAGV.LoadTrackInTotal.ToString() + "出:" + FormAGV.LoadTrackOutTotal.ToString() + "  " + msg, MsgType.AGV);
        ...
        private void timerAGV_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (m_EmergencyStop == 128)
                {
                    ...
                    {
                        axActUtlType1.SetDevice2("M1218", 0); //伸出
                        axActUtlType1.SetDevice2("M1219", 0);
                        Thread.Sleep(10);
                ...
                if (agvAlarmFlag)
                {
                    AddListMsg("右侧agv对接状态超时,皮带停止转动,请检查" + "当前对接步骤:" + m_ucLoadAGVStep.ToString());
                }
                ...
                if ((m_ucLoadAGVStep != 20) && (!LongLoadIn1Safe) && (!LongLoadIn2Safe) && (!LongLoadOut1Safe) && (!LongLoadOut2Safe) && (!agvWorkFlagIn) && (!agvWorkFlagOut))
                {
                    ...
                    else
                    {
                        ...
                        m_ucLoadAGVStep = 20;
                        m_AGVHandShakeState = 0;
                        AddListMsg("检测到接驳台复位，右侧自动强制对接完成！");
                    }
                }
                else
                {
                ...
                if (m_AGVHandShakeState == 3)
                {
                    switch (m_ucLoadAGVStep)
                    {
                            ...
                            if ((FormAGV.LoadTrackInTotal == 0) && (FormAGV.LoadTrackOutTotal >= FormAGV.CassetteNumberConstant) && (m_AGVHandShakeState == 3)/* && (LongLoadIn1OutStretch) && (LongLoadIn2OutStretch)*/)
                            {
                                if ((LED_SafeIn1.Value == false) && (LED_SafeIn2.Value == false) && (LED_SafeOut1.Value == false) && (LED_SafeOut2.Value == false))  //安全光电状态状态正确
                                {
                                    if ((AGVAllowIn) && (AGVAllowOut))
                                    {
                                        ...
                                        axActUtlType1.SetDevice2("M1755", 1);
                                        axActUtlType1.SetDevice2("M1757", 1);
                                    }
                                    else
                                    {
                        ...
                        case 3:
                            ...
                            {
                                if ((LED_SafeIn1.Value == false) && (LED_SafeIn2.Value == false) && (LED_SafeOut1.Value == false) && (LED_SafeOut2.Value == false))
                                {
                                    //axActUtlType1.SetDevice2("M1218", 1); //缩回
                                    //axActUtlType1.SetDevice2("M1219", 1);
                                    //Thread.Sleep(10);

                                    axActUtlType1.SetDevice2("M100", 1);
                                    axActUtlType1.SetDevice2("M150", 1);
                                    axActUtlType1.SetDevice2("M950", 1);
                                    axActUtlType1.SetDevice2("M1000", 1);
                ...
                if (m_AGVHandShakeState == 1)
                {
                    switch (m_ucLoadAGVStep)
                    {
                        ...
                        case 3:
                            ...
                            {      //出料进料允许     5进5出
                                ...
                                if ((LED_SafeIn1.Value == false) && (LED_SafeIn2.Value == false))  //安全光电状态状态正确
                                {
                                    ...
                                    axActUtlType1.SetDevice2("M100", 1); ;//进料气缸左伸出
                                    axActUtlType1.SetDevice2("M150", 1); ;//进料气缸左伸出
                        ...
                        case 5:
                            ...
                            {
                                axActUtlType1.SetDevice2("M100", 0); ;//进料气缸左伸出
                                axActUtlType1.SetDevice2("M150", 0); ;//进料气缸左伸出
                    ...
                    switch (m_ucLoadAGVStep)
                    {
                        ...
                        case 3:
                            ...
                            if ((LED_SafeOut1.Value == false) && (LED_SafeOut2.Value == false))  //安全光电状态状态正确
                            {
                                ...
                                axActUtlType1.SetDevice2("M1218", 1); //缩回
                                axActUtlType1.SetDevice2("M1219", 1); //缩回
                                Thread.Sleep(10);
                        ...
                        case 5:
                            ...
                            if ((FormAGV.LoadTrackOutTotal == 0) && (LED_SafeOut1.Value == false) && (LED_SafeOut2.Value == false))
                            {
                                ...
                                axActUtlType1.SetDevice2("M1218", 0);
                                axActUtlType1.SetDevice2("M1219", 0);
                                m_ucLoadAGVStep = 6;
                            }
                            else
            ...
            {
                AddListMsg("右侧：AGV Timer对接流程出错：" + ex.Message);
            }
        }
        ...
        public bool LongLoadIn1Safe = false;
        public bool LongLoadIn1OutStretch = false;



        public bool LongLoadIn2Safe = false;
        public bool LongLoadIn2OutStretch = false;


        public bool LongLoadOut1Safe = false;
        public bool LongLoadOut1OutStretch = false;


        public bool LongLoadOut2Safe = false;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (LED_PLC.Value)
                {
                    ...
                    Int16 AGVAlarmRet = 0;
                    axActUtlType1.ReadDeviceRandom2("M1591\n", 1, out AGVAlarmRet);//chu料右对接允许
                    ...
                    //LoadTrackIn1 = ReadValue1[25];//左下
                    //LoadTrackIn2 = ReadValue1[26];//右下
                    //LoadTrackOut1 = ReadValue1[27];//左shang
                    //LoadTrackOut2 = ReadValue1[28];//右上

                    FormAGV.LoadTrackIn1 = ReadValue1[29];//左下
                    FormAGV.LoadTrackIn2 = ReadValue1[30];//右下
                    FormAGV.LoadTrackOut1 = ReadValue1[31];//左shang
                    FormAGV.LoadTrackOut2 = ReadValue1[32];//右上
            ...
            {
                AddListMsg("右侧AGV IO扫描异常：" + ex.Message);
            }
        ...
        {
            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[20]", false);
            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[21]", false);

            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[22]", false);
            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[23]", false);

            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[24]", false);
            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[25]", false);

            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[26]", false);
            //formHmi.WriteToPlc_Bool(".Feed_Ctrl_HMI[27]", false);
        ...
        private void KEY_OutSyc1_StateChanged(object sender, NationalInstruments.UI.ActionEventArgs e)
        {
            ...
            //{
            //    axActUtlType1.SetDevice2("M2018", 1); //缩回
            //}
            //else if (KEY_OutSyc1.Value == false)
            //{
            //    axActUtlType1.SetDevice2("M2018", 0); ;//进料气缸左伸出
            //}
        }
        ...
        private void checkBoxNOagv_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //    {
            //        cfg_MES_Agv.WriteConfig("MES", "eap_portstatus_2", 0);
            //    }
            //    else
            //    {
            //        cfg_MES_Agv.WriteConfig("MES", "eap_portstatus_2", 1);
            //    }
            //}
            //else
            //{
        ...
        private void FormAGV_COM2_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                axActUtlType1.Close();
        ...
        private void led_AGVAllowIn_StateChanged(object sender, NationalInstruments.UI.ActionEventArgs e)
        {

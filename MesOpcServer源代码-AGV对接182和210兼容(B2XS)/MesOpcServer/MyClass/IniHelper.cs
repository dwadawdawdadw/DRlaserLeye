...
namespace IniHelper
{
    ...
    {
        //   2020年6月9日  Aaron  修改:写字符串的时候,去掉\r\n
        //   2021年1月27日  Novel 增加Bool值的写入方法重载

        private string _filePath = "D:\\DRLaser\\MES\\";
        private string _fileName = "MES.ini";
        ...
        public Configure(string FullFilePath)
        {
        ...
        {
            StringBuilder strReturn = new StringBuilder(4096);
            GetPrivateProfileString(strAppName, strKeyName, strDefault, strReturn, 4096, strFilepath);
        ...
        public bool WriteConfig(string strAppName, string strKeyName, bool strString)
        {
            return WritePrivateProfileString(strAppName, strKeyName, strString.ToString(), _filePath + _fileName);
        }

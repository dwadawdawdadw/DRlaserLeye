...
namespace AutoStartHelper
{
    class AutoStart
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "MES OPC Server";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(systemStartPath, QuickName, appAllPath, "MES OPC Server");
                }
            }
            else//开机不启动
            {
        ...
        public void CreateDesktopQuick(string desktopPath = "", string quickName = "", string appPath = "")
        {
            ...
            {
                CreateShortcut(desktopPath, quickName, appPath, "帝尔激光OPC UA服务器");
            }
        }
